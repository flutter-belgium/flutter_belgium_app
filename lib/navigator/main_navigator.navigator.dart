...
import '../screen/qr_scanner/qr_scanner_screen.dart';
...
mixin BaseNavigator {
  ...
  void goToQrScannerScreen({_i2.Key? key}) => navigatorKey.currentState?.pushNamedAndRemoveUntil<dynamic>(
  ...
  Future<void> goToDebugChangeTargetPlatformScreen({_i1.Key? key}) async => navigatorKey.currentState?.pushNamed<dynamic>(
        RouteNames.debugChangeTargetPlatformScreen,
        arguments: {'key': key},
      );
  Future<void> goToDebugChangeLanguageScreen({_i1.Key? key}) async => navigatorKey.currentState?.pushNamed<dynamic>(
