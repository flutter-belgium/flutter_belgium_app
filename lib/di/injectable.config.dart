...
import 'package:flutter_belgium/model/data/remote_config/remote_config_data.dart' as _i16;
...
import 'package:flutter_belgium/viewmodel/debug/debug_change_language_viewmodel.dart' as _i23;
import 'package:flutter_belgium/viewmodel/debug/debug_change_target_platform_viewmodel.dart' as _i24;
...
import 'package:flutter_belgium/viewmodel/force_update/force_update_viewmodel.dart' as _i7;
import 'package:flutter_belgium/viewmodel/global/global_viewmodel.dart' as _i8;
import 'package:flutter_belgium/viewmodel/global/translations_viewmodel.dart' as _i20;
...
import 'package:flutter_belgium/viewmodel/login/user_name_viewmodel.dart' as _i21;
import 'package:flutter_belgium/viewmodel/raffle/raffle_viewmodel.dart' as _i14;
import 'package:flutter_belgium/viewmodel/raffle/raffle_winner_picker_viewmodel.dart' as _i15;
import 'package:flutter_belgium/viewmodel/settings/settings_viewmodel.dart' as _i18;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt initGetIt({
    ...
    gh.lazySingleton<_i6.FirebaseRemoteConfig>(() => registerModule.provideRemoteConfig());
    ...
    gh.lazySingleton<_i10.LocaleRepository>(() => _i10.LocaleRepository(gh<_i3.SharedPrefsStore>()));
    ...
    gh.factory<_i15.RaffleWinnerPickerViewModel>(() => _i15.RaffleWinnerPickerViewModel(
          gh<_i13.RaffleRepository>(),
          gh<_i12.MainNavigator>(),
        ));
    gh.lazySingleton<_i3.RemoteConfigRepository<_i16.RemoteConfigData>>(() => _i17.AppRemoteConfigRepository(
    ...
    gh.lazySingleton<_i20.TranslationsViewmodel>(() => _i20.TranslationsViewmodel(gh<_i10.LocaleRepository>()));
    gh.factory<_i21.UserNameViewModel>(() => _i21.UserNameViewModel(
          gh<_i11.LoginRepository>(),
          gh<_i12.MainNavigator>(),
        ));
    gh.lazySingleton<_i3.VersionCheckService>(() => registerModule.provideVersionCheckService(gh<_i12.MainNavigator>()));
    gh.lazySingleton<_i22.AirtableService>(() => registerModule.providerAirtableService(gh<_i3.Dio>()));
    gh.factory<_i23.DebugChangeLanguageViewModel>(() => _i23.DebugChangeLanguageViewModel(
          gh<_i20.TranslationsViewmodel>(),
          gh<_i12.MainNavigator>(),
        ));
    gh.factory<_i24.DebugChangeTargetPlatformViewModel>(() => _i24.DebugChangeTargetPlatformViewModel(
    ...
    gh.lazySingleton<_i26.EventRepository>(() => _i26.EventRepository(gh<_i22.AirtableService>()));
    gh.factory<_i27.EventsViewmodel>(() => _i27.EventsViewmodel(gh<_i26.EventRepository>()));
    gh.factory<_i28.LoginViewModel>(() => _i28.LoginViewModel(
          gh<_i11.LoginRepository>(),
          gh<_i12.MainNavigator>(),
        ));
    gh.lazySingleton<_i29.TalkRepository>(() => _i29.TalkRepository(gh<_i22.AirtableService>()));
    gh.factory<_i30.TalksViewmodel>(() => _i30.TalksViewmodel(gh<_i29.TalkRepository>()));
    return this;
  }
}
